...
@admin = User.create(name: "Admin", email: "admin@mail.com", password: "hello123")
@developer = User.create(name: "developer", email: "developer@mail.com", password: "hello123")
...
@project.collaborators << [@developer]
@project.save